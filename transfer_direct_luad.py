...
The current version of the script doesnot load the KIRC model variables directly but re-run the SdA with KIRC dataset to obtain the KIRC model variables
