...
The hidden layer of KIRC model is used as a pretrain model and then do fine tuning the variables using the LUAD datasets with a lower learning rate at 0.0005
...
result_prefix="./luad/results_fineTuning9.2/"
...
for one in datasets:
	...
	if one == "mirna.expr":
		...
		model_trained_mirna_2, train_set_x_extr_mirna_2, training_time_mirna_2 = dA_finetuning3.train_model(train_set_x_org=test_set_x_org, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
	...
	if one == "protein.expr":
		...
		model_trained_prt_2, train_set_x_extr_prt_2, training_time_prt_2 = dA_finetuning3.train_model(train_set_x_org=test_set_x_org, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
	...
	if one == "gn.expr":
		...
		lines = loadtxt(paranm, comments="#")
		bhid = theano.shared(value=lines, name='b', borrow=True)
		model_trained_1_gn_2, train_set_x_extr_1_gn_2, training_time_1_gn_2 = dA_finetuning3.train_model(train_set_x_org=test_set_x_org, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
		...
		lines = loadtxt(paranm, comments="#")
		bhid = theano.shared(value=lines, name='b', borrow=True)
		model_trained_2_gn, train_set_x_extr_2_gn, training_time_2_gn = dA_finetuning3.train_model(train_set_x_org=train_set_x_extr_1_gn_2, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
	...
	if one == "methy":
		...
		model_trained_1_methy_2, train_set_x_extr_1_methy_2, training_time_1_methy_2 = dA_finetuning3.train_model(train_set_x_org=test_set_x_org, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
		...
		lines = loadtxt(paranm, comments="#")
		bhid = theano.shared(value=lines, name='b', borrow=True)
		model_trained_2_methy, train_set_x_extr_2_methy, training_time_2_methy = dA_finetuning3.train_model(train_set_x_org=train_set_x_extr_1_methy_2, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
	...
	if one == "cna.nocnv.nodup":
		...
		lines = loadtxt(paranm, comments="#")
		bhid = theano.shared(value=lines, name='b', borrow=True)
		model_trained_1_cna_2, train_set_x_extr_1_cna_2, training_time_1_cna_2 = dA_finetuning3.train_model(train_set_x_org=test_set_x_org, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
		...
		lines = loadtxt(paranm, comments="#")
		bhid = theano.shared(value=lines, name='b', borrow=True)
		model_trained_2_cna, train_set_x_extr_2_cna, training_time_2_cna = dA_finetuning3.train_model(train_set_x_org=train_set_x_extr_1_cna_2, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
...
lines = loadtxt(paranm, comments="#")
bhid = theano.shared(value=lines, name='b', borrow=True)
model_trained_1, com_hidden_x_extr_1, training_time_1 = dA_finetuning3.train_model(train_set_x_org=com_hidden, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
n_hidden=10
...
lines = loadtxt(paranm, comments="#")
bhid = theano.shared(value=lines, name='b', borrow=True)
model_trained_21, com_hidden_x_extr_21, training_time_21 = dA_finetuning3.train_model(train_set_x_org=com_hidden_x_extr_1, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
n_hidden=1
...
lines = loadtxt(paranm, comments="#")
bhid = theano.shared(value=lines, name='b', borrow=True)
model_trained_2, com_hidden_x_extr_2, training_time_2 = dA_finetuning3.train_model(train_set_x_org=com_hidden_x_extr_21, training_epochs=n_epochs, batch_size=batch_size, n_hidden=n_hidden, learning_rate=lr2, corruption_level=corruption_level, cost_measure="cross_entropy", rng=rng, W=W, bhid=bhid, bvis=bvis)
