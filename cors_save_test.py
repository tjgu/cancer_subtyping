...
def test_cor(model_trained_2, model_trained_21, model_trained_1, model_trained_mirna, model_trained_prt, model_trained_1_gn, model_trained_2_gn, model_trained_1_methy, model_trained_2_methy, model_trained_1_cna, model_trained_2_cna, mirna_expr_org_test, prt_expr_org_test, gn_expr_org_test, methy_expr_org_test, cna_expr_org_test, result_dir):
	...
	[mirna_ave1_t, mirna_ave2_t] = cors_save.mirna_cor_save(model_trained_2, model_trained_21, model_trained_1, model_trained_mirna, com2_h, mirna1_h, mirna_expr_org_test, result_dir)
	[prt_ave1_t, prt_ave2_t] = cors_save.prt_cor_save(model_trained_2, model_trained_21, model_trained_1, model_trained_prt, com2_h, prt1_h, prt_expr_org_test, result_dir)
        [gn_ave1_t, gn_ave2_t] = cors_save.gn_cor_save(model_trained_2, model_trained_21, model_trained_1, model_trained_1_gn, model_trained_2_gn, com2_h, gn2_h, gn_expr_org_test, result_dir)
        [methy_ave1_t, methy_ave2_t] = cors_save.methy_cor_save(model_trained_2, model_trained_21, model_trained_1, model_trained_1_methy, model_trained_2_methy, com2_h, methy2_h, methy_expr_org_test, result_dir)
        [cna_ave1_t, cna_ave2_t] = cors_save.cna_cor_save(model_trained_2, model_trained_21, model_trained_1, model_trained_1_cna, model_trained_2_cna, com2_h, cna2_h, cna_expr_org_test, result_dir)
